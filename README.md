...
# Note: You can replace `generate()` with `generate_fast()` for 2x-4x speedups on CUDA devices!
wav = model.generate_fast(text, audio_prompt_path="your_10s_ref_clip.wav")
...
wav_french = multilingual_model.generate_fast(french_text, language_id="fr")
ta.save("test-french.wav", wav_french, multilingual_model.sr)

chinese_text = "你好，今天天气真不错，希望你有一个愉快的周末。"
wav_chinese = multilingual_model.generate_fast(chinese_text, language_id="zh")
